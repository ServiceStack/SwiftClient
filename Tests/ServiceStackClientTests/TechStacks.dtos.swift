/* Options:
 ...
 //IncludeTypes:
 ExcludeTypes: QueryBase`1,QueryResponse,FindTechnologies,Authenticate,AuthenticateResponse,AssignRoles,AssignRolesResponse,UnAssignRoles,UnAssignRolesResponse,Ping
